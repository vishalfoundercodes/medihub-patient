...
export default function OrderHelpBar() {
  return (
    <div className="bg-[var(--color-bg-section)] rounded-2xl border border-[var(--color-border)] p-5 flex items-center justify-between gap-4 flex-wrap">
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="font-bold text-[var(--color-text-dark)]">Need Help with your order?</p>
          <p className="text-sm text-[var(--color-text-secondary)]">Our support team is here to assist you.</p>
        </div>
      </div>
