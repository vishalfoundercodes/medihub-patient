...
export default function AppointmentPagination({ current, total, perPage, onChange }) {
  ...
  return (
    <div className="flex items-center justify-between flex-wrap gap-4">
      <p className="text-sm text-[var(--color-text-secondary)]">
        ...
        <span className="font-semibold text-[var(--color-text-dark)]">{total}</span> appointments
      </p>
